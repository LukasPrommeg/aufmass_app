...
class RoomWall {
  ...
  RoomWall({
    ...
    walls.add(Wall.fromStart(angle: 90, length: wall.length, start: Corner.fromPoint(point: Offset.zero)));
    walls.add(Wall.fromStart(angle: 180, length: height, start: walls.last.end));
    walls.add(Wall.fromStart(angle: 270, length: wall.length, start: walls.last.end));
